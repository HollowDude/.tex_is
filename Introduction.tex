...
El \textbf{objetivo general} de esta investigación es desarrollar un sistema de carga fragmentada y 
...
\begin{enumerate}
  ...
  \item Diseñar un sistema de carga fragmentada que permita la persistencia del progreso y el
...
\begin{itemize}
  ...
  la solución especializada para Picta \citep{Wohlin2012}.
